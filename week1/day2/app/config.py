...
class Settings(BaseSettings):
    ...
    # Gemini 2.0 Flash is fast, free-tier-friendly, and good enough for week 1.
    # Other options: gemini-2.5-flash, gemini-2.5-pro (slower, more capable).
    default_model: str = "gemini-2.0-flash"
    default_max_tokens: int = 1024
    default_temperature: float = 0.7

    # Network-level safety net. Per-request budget should usually be tighter.
